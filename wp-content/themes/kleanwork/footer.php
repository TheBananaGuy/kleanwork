		    ...
		    <footer class="band band--banner band--dark b-lazy-bg">
		        <div class="wrap">
		            ...
		            <h2>FANG OS P&#197;</h2>
		                    ...
		                    <p class="contact-phone"><a href="tel:70260727"><span>70 260 727</span></a></p>

		            <div class="some">
		                    <div class="some__icon">
		                        <a href="https://www.facebook.com/klean.dk" target="_blank"><span class="icon icon-facebook"></span></a>
		                    </div>

		                    <div class="some__icon">
		                        <a href="http://twitter.com/Klean" target="_blank"><span class="icon icon-twitter"></span></a>
		                    </div>

		                    <div class="some__icon">
		                        <a href="https://www.instagram.com/klean.dk/" target="_blank"><span class="icon icon-instagram"></span></a>
		                    </div>

		                    <div class="some__icon">
		                        <a href="https://www.linkedin.com/company/202655" target="_blank"><span class="icon icon-linkedin"></span></a>
		                    </div>
		            </div>
